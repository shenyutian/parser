...
/**
 * {@link org.syt.parser.apk.cert.asn1.ber.BerDataValueReader} which reads from an {@link InputStream} returning BER-encoded data
...
public class InputStreamBerDataValueReader implements BerDataValueReader {
    ...
    private static BerDataValue readDataValue(InputStream input)
            throws org.syt.parser.apk.cert.asn1.ber.BerDataValueFormatException {
        ...
        try {
            ...
            throw new org.syt.parser.apk.cert.asn1.ber.BerDataValueFormatException("Failed to read data value", e);
        }
    }

    private static int readTagNumber(InputStream in, int firstIdentifierByte)
            throws IOException, org.syt.parser.apk.cert.asn1.ber.BerDataValueFormatException {
