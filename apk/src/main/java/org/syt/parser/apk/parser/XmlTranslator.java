...
import org.syt.parser.apk.utils.xml.XmlEscaper;
...
public class XmlTranslator implements XmlStreamer {
    ...
    private int shift = 0;
    private org.syt.parser.apk.parser.XmlNamespaces namespaces;
    private boolean isLastStartTag;

    public XmlTranslator() {
        sb = new StringBuilder();
        sb.append("<?xml version=\"1.0\" encoding=\"utf-8\"?>\n");
        this.namespaces = new org.syt.parser.apk.parser.XmlNamespaces();
    }
    ...
    public void onStartTag(XmlNodeStartTag xmlNodeStartTag) {
        ...
        List<org.syt.parser.apk.parser.XmlNamespaces.XmlNamespace> nps = namespaces.consumeNameSpaces();
        if (!nps.isEmpty()) {
            for (org.syt.parser.apk.parser.XmlNamespaces.XmlNamespace np : nps) {
