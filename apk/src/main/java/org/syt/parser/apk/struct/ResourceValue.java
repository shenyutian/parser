package org.syt.parser.apk.struct;

import org.syt.parser.apk.struct.AndroidConstants;
import org.syt.parser.apk.struct.ResValue;
...
public abstract class ResourceValue {
    ...
    public static ResourceValue string(int value, org.syt.parser.apk.struct.StringPool stringPool) {
    ...
    private static class StringResourceValue extends ResourceValue {
        private final org.syt.parser.apk.struct.StringPool stringPool;
