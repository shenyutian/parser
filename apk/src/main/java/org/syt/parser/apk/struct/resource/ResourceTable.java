...
import org.syt.parser.apk.utils.ResourceLoader;
...
public class ResourceTable {
    ...
    public List<Resource> getResourcesById(long resourceId) {
        ...
        for (Type type : types) {
            org.syt.parser.apk.struct.resource.ResourceEntry resourceEntry = type.getResourceEntry(entryIndex);
    ...
    public static class Resource {
        ...
        private Type type;
        private org.syt.parser.apk.struct.resource.ResourceEntry resourceEntry;

        public Resource(TypeSpec typeSpec, Type type, org.syt.parser.apk.struct.resource.ResourceEntry resourceEntry) {
