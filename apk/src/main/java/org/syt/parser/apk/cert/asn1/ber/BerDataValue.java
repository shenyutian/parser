...
import org.syt.parser.apk.cert.asn1.ber.ByteBufferBerDataValueReader;
...
public class BerDataValue {
    ...
    /**
     * Returns the tag class of this data value. See {@link org.syt.parser.apk.cert.asn1.ber.BerEncoding} {@code TAG_CLASS}
     * constants.
     */
     ...
     */
    public org.syt.parser.apk.cert.asn1.ber.BerDataValueReader contentsReader() {
     ...
     */
    public org.syt.parser.apk.cert.asn1.ber.BerDataValueReader dataValueReader() {
