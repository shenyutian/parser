...
import org.syt.parser.apk.struct.resource.*;
import org.syt.parser.apk.utils.Buffers;
import org.syt.parser.apk.utils.ParseUtils;
...
public class Type {
    ...
    public Type(org.syt.parser.apk.struct.resource.TypeHeader header) {
    ...
    public org.syt.parser.apk.struct.resource.ResourceEntry getResourceEntry(int id) {
        ...
        if (offsets[id] >= buffer.array().length) {
            return null;
        }
    ...
    private org.syt.parser.apk.struct.resource.ResourceEntry readResourceEntry() {
        long beginPos = buffer.position();
        org.syt.parser.apk.struct.resource.ResourceEntry resourceEntry = new org.syt.parser.apk.struct.resource.ResourceEntry();
