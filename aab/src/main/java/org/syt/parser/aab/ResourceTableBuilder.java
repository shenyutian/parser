...
/**
 * Builder for generating {@link Resources.ResourceTable}.
 */
public class ResourceTableBuilder {
    ...
    public class PackageBuilder {
         ...
         * @return The resource type builder.
         */
        Resources.Type.Builder addResourceType(Resources.Type resType) {
         ...
         * @return The package builder.
         */
        public PackageBuilder addResource(Resources.Type resType, Resources.Entry resEntry) {
...
//            System.out.println(resType.getName() + " " + resEntry.getName());
